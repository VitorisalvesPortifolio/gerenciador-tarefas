...
import TaskUpdate from "../components/TaskUpdate"; // novo: import TaskUpdate
...
const TaskPage = () => {
  ...
  const [taskToEdit, setTaskToEdit] = useState(null); // novo: para editar
  ...
  /**
   * Atualiza uma tarefa localmente depois de editada
   */
...
{tasks.length === 0 ? (
  ...
  <ul className="task-list">
    {tasks.map((task) => (
      ...
      {/* Formulário para atualizar a tarefa selecionada */}
      {taskToEdit && (
